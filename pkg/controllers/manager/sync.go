...
type action interface {
	Execute(ctx context.Context, client *managerclient.Client, status *v1alpha1.ClusterStatus) error
}
...
func (a *addClusterAction) Execute(ctx context.Context, client *managerclient.Client, status *v1alpha1.ClusterStatus) error {
...
func (a *updateClusterAction) Execute(ctx context.Context, client *managerclient.Client, _ *v1alpha1.ClusterStatus) error {
...
func (a *deleteClusterAction) Execute(ctx context.Context, client *managerclient.Client, status *v1alpha1.ClusterStatus) error {
...
func (a *deleteTaskAction) Execute(ctx context.Context, client *managerclient.Client, status *v1alpha1.ClusterStatus) error {
...
func (a *addTaskAction) Execute(ctx context.Context, client *managerclient.Client, status *v1alpha1.ClusterStatus) error {
...
func (a *updateTaskAction) Execute(ctx context.Context, client *managerclient.Client, status *v1alpha1.ClusterStatus) error {
