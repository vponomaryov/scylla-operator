...
dev-helm-publish: HELM_REPOSITORY=https://scylla-operator-charts-dev.storage.googleapis.com/$(HELM_CHANNEL)
dev-helm-publish: HELM_BUCKET=gs://scylla-operator-charts-dev/$(HELM_CHANNEL)
dev-helm-publish: helm-publish
